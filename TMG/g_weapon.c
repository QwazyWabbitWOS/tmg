...
void fire_rail (edict_t *self, vec3_t start, vec3_t aimdir, int damage, int kick)
{
	...
	if(j == 2)
	{
		Com_sprintf(string, sizeof string, "%s got a double rail!!\n", self->client->pers.netname);
		...
		if (extrasounds->value)
		{
			...
			{
			case 0:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/doublekill.wav"), 1, ATTN_NORM, 0);
				break;
			case 1:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/doublekillf.wav"), 1, ATTN_NORM, 0);
				break;
			case 2:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/multikill.wav"), 1, ATTN_NORM, 0);
				break;
			case 3:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/multikillf.wav"), 1, ATTN_NORM, 0);
				break;
			case 4:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/ultrakill.wav"), 1, ATTN_NORM, 0);
				break;
			case 5:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/ultrakillf.wav"), 1, ATTN_NORM, 0);
				break;
			default:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/doublekillf.wav"), 1, ATTN_NORM, 0);
				break;
	...
	{
		if (j == 3)
			Com_sprintf(string, sizeof string, "%s got a triple rail!!\n", self->client->pers.netname);
		else if (j == 4)
			Com_sprintf(string, sizeof string, "%s got a quadruple rail!!\n", self->client->pers.netname);
		else
			Com_sprintf(string, sizeof string, "%s railed %d people!!\n", self->client->pers.netname, j);
		highlight_text(string, string);
		my_bprintf(PRINT_HIGH, string);
		if (extrasounds->value)
		{
			...
			{
			case 0:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/holyshitf.wav"), 1, ATTN_NORM, 0);
				break;
			case 1:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/ludicrouskill.wav"), 1, ATTN_NORM, 0);
				break;
			case 2:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/megakill.wav"), 1, ATTN_NORM, 0);
				break;
			case 3:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/mmmmonster.wav"), 1, ATTN_NORM, 0);
				break;
			case 4:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/monsterkill.wav"), 1, ATTN_NORM, 0);
				break;
			default:
				gi.sound (self, CHAN_AUTO, gi.soundindex ("misc/megakill.wav"), 1, ATTN_NORM, 0);
				break;
