...
//------------------------------------------------------------
static
qboolean B_UseHyperBlaster(edict_t *ent,
						   edict_t *target,
						   int enewep,
						   float aim,
						   float distance,
...
//------------------------------------------------------------
static
qboolean B_UseRocket(edict_t *ent,
					 edict_t *target,
					 int enewep,
					 float aim,
					 float distance,
...
//------------------------------------------------------------
static
qboolean B_UseRailgun(edict_t *ent,
					  edict_t *target,
					  int enewep,
					  float aim,
					  float distance,
...
//------------------------------------------------------------
static
qboolean B_UseGrenadeLauncher(edict_t *ent,
							  edict_t *target,
							  int enewep,
							  float aim,
							  float distance,
...
//------------------------------------------------------------
static
qboolean B_UseChainGun(edict_t *ent,
					   edict_t *target,
					   int enewep,
					   float aim,
					   float distance,
...
//------------------------------------------------------------
static
qboolean B_UseMachineGun(edict_t *ent,
						 edict_t *target,
						 int enewep,
						 float aim,
						 float distance,
...
//------------------------------------------------------------
static
qboolean B_UseSuperShotgun(edict_t *ent,
						   edict_t *target,
						   int enewep,
						   float aim,
						   float distance,
...
//------------------------------------------------------------
static
qboolean B_UseShotgun(edict_t *ent,
					  edict_t *target,
					  int enewep,
					  float aim,
					  float distance,
...
//------------------------------------------------------------
static
qboolean B_UseHandGrenade(edict_t *ent,
						  edict_t *target,
						  int enewep,
						  float aim,
						  float distance,
...
//------------------------------------------------------------
static
qboolean B_UseBlaster(edict_t *ent,
					  edict_t *target,
					  int enewep,
					  float aim,
					  float distance,
